...
export default function UpgradeModal({ open, onClose }: UpgradeModalProps) {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-sm rounded-2xl border border-emerald-500 bg-zinc-900/50 backdrop-blur-lg p-6 shadow-xl shadow-emerald-500/20 text-center"
