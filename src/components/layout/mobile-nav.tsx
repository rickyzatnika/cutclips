        ...
        {session ? (
          ...
          <>
            <Link
              href="/workspace"
              className={`flex flex-1 flex-col items-center gap-0.5 py-3 text-[14px] font-medium transition-colors ${
                pathname === "/workspace" ? "text-emerald-400" : "text-zinc-500 hover:text-zinc-300"
              }`}
            >
            ...
            <Link
              href="/login"
              className="flex flex-1 flex-col items-center gap-0.5 py-3 text-[14px] font-medium text-emerald-400 transition-colors hover:text-emerald-300"
            >
